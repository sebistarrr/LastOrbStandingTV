...
| **Comète** (inventée) | **une ceinture de débris qui ne touche pas** — sa hitbox est nulle sur ses trois clés, donc `resolveMelee` ne tourne jamais pour elle : la ceinture est un **dessin**, découpé de la même maquette que son corps (le tourbillon est la sphère, tout ce qui l'entoure est l'arme). C'est son module qui inflige les dégâts, au contact | **la plus rapide et la plus petite** (700 px/s de base et rayon 34, contre 655 et 41 au précédent record), et elle **file droit sans viser** — son cap ne change qu'aux rebonds de mur : **son élan est son arme**. Un facteur continu monte tout seul de 1 à 1,5 tant qu'elle ne touche personne, multiplie sa vitesse *et* ses dégâts, et **chaque choc le dépense** — elle est donc la plus dangereuse juste après avoir raté. Coup de fouet : toutes les 6 s, l'élan saute à 1,9, au-dessus de son propre plafond. **Rebond** : chaque mur touché lui rend de l'élan (plafond 1,7) — son temps mort devient de l'accumulation. **Fragmentation** : toutes les 10 s, huit éclats de sa propre ceinture partent en anneau complet, et la salve lui **coûte** 0,2 d'élan — le seul pouvoir du jeu qui se paie dans la ressource de son porteur | Rentrée / REENTRY — 4,5 s où l'élan est tenu à 2,3 (1 610 px/s), le verrou de touche tombe de moitié et **les chocs ne coûtent plus rien** |
